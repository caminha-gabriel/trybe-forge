...
const units: any = ['kg', 'hg', 'dag', 'g', 'dg', 'cg', 'mg'];

function convertWeight(value: number, baseUnity: string, convertUnity: string): number {
...
function exec(): void {
  ...
  const result: number = convertWeight(selectedValue, selectedBase, selectedConvertion);
