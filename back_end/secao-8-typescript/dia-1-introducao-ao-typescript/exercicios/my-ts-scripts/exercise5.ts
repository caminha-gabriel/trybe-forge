...
function convertDistance(value: number, baseUnity: string, convertUnity: string): number {
...
function exec(): void {
  ...
  const result: number = convertDistance(selectedValue, selectedBase, selectedConvertion);
